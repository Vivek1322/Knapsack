...
int main()
{
    ...
    do
    {
        printf("\n\nTo view, the key to your  healthy lifestyle\n\n\nPress 1 to follow our diet plan\nPress other integer to create your own diet plan\n\n ");

        if(!(scanf("%d",&a)))
        {
            printf("You tried to be tricky. You must enter a valid integer.\n");
        ...
        if(a==1)
        {
            printf("\nSR. NO     FOOD ITEM      WEIGHT  CALORIES\n");
